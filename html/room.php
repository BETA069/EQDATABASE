                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h3 class="card-header m-0 me-2 pb-3">จัดการห้องที่ใช้งาน</h3>
...
<table width="333" border="0" class="table table-hover">
   <tbody>
    <tr style="background-color: #777e5c">
      ...
      <td width="91" align="center"><strong>ห้องที่ใช้งาน</strong></td>
	...
	<td align="center"><a href="editroom.php?eid=<?php echo $row['room_id'];?>">
	  <button type="button" class="btn btn-warning">แก้ไข</button>
	</a>
		<a href="delroom.php?eid=<?php echo $row['room_id'];?>">

                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h3 class="card-header m-0 me-2 pb-3">จัดการแหล่งเงิน</h3>
...
<table width="333" border="0" class="table table-hover">
  <tbody>
    <tr style="background-color: #777e5c">
      ...
      <td width="91" align="center"><strong>แหล่งเงิน</strong></td>
      <td width="85" align="center"><strong>จัดการ</strong></td>
    </tr>
    <tr>
		<?php 
		$sql = "SELECT * FROM `source_money`";
		$result = mysqli_query($con, $sql);
		if (mysqli_num_rows($result)>0){
			while ($row = mysqli_fetch_assoc($result)){
				
		?>
      <td align="center"><?php echo $row['money_id'];?></td>
      <td align="center"><?php echo $row['money'];?></td>
	<td align="center"><a href="editmon.php?eid=<?php echo $row['money_id'];?>">

                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h3 class="card-header m-0 me-2 pb-3">แก้ไขข้อมูลครุภัณฑ์ต่ำกว่าเกณฑ์</h3>
                    ...
                    $sql = "SELECT * FROM `eqlow` WHERE `sum_id`=$eid";
                    $result = mysqli_query($con, $sql);
                    if(mysqli_num_rows($result) > 0){
                        while($row = mysqli_fetch_assoc($result)){	 
                    ?>
                 <form action="editeqlow2.php?eid=<?php echo $eid; ?>" method="post" enctype="multipart/form-data">
        <!-- Row 1 -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
				    ...
				    <?php }} ?>
					<br>
					<a href="editeqlowpic.php?eid=<?php echo $eid;?>">

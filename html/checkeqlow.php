                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h3 class="card-header m-0 me-2 pb-3">รายงานการตรวจสภาพครุภัณฑ์ต่ำกว่าเกณฑ์</h3>
                    ...
                    <div class="table-responsive">
                      <table width="802" border="0" class="table table-hover" style="color: #283106">
                        <tbody>
                          <tr style="background-color: #777e5c">
                            <td width="56" align="center"><strong>ที่</strong></td>
                            <td width="350" align="center"><strong>หมายเลขครุภัณฑ์</strong></td>
                            <td width="409" align="center"><strong>สภา</strong>พปัจจุบัน</td>
                            <td width="494" align="center"><strong>จัดการ</strong></td>
                          </tr>
                          <?php
							$eid=$_GET['eid'];
							$n=1;
                          ...
                          <tr>
                            ...
                            <td align="center">
                              ...
                              <a href="checkeqlow2.php?eid=<?php echo $row['eq_id'];?>">

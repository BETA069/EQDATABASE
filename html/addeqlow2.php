...
$sql = "INSERT INTO `eqlow`(`sumnum`, `name`, `type`, `date1`, `date2`, `money`, `num`, `room`, `responsible`, `numstart`, `numend`, `moneynum`, `tranfer`, `price`, `pic`, `num1`, `num2`, `num3`, `num4`) 
        VALUES ('$num1-$num2-$num3-$num4-$numstart', '$name', '$type', '$date1', '$date2', '$sm', '$number', '$room', '$rp', '$numstart', '$numend', '$moneynum', '$st', '$price', '$myfile', '$num1', '$num2', '$num3', '$num4')";
// ประมวลผลคำสั่ง SQL
...
for ($i = $start_suffix; $i <= $end_suffix; $i++) {
    ...
    $sql = "INSERT INTO `equipments_low`(`eq_code`, `sum_id`) VALUES ('$equipment_no','$sum_id')";
    $result = mysqli_query($con, $sql);
    ...
    $sql = "INSERT INTO `heleqlow`(`eq_id`, `hel`, `date`) VALUES ('$eq_id', 'ปกติ', '$current_date')";
    $result = mysqli_query($con, $sql);

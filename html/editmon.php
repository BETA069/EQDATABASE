...
>
  ...
  <body>
                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h3 class="card-header m-0 me-2 pb-3">แก้ไขแหล่งเงิน</h3>
	...
	?>
							...
							<form action="editmon2.php?eid=<?php echo $eid;?>" method="post" >
  ...
  <tbody>
    <tr>
	  ...
	  <?php 
		$sql = "SELECT * FROM `source_money` WHERE `money_id` = $eid";
    ...
    <tr>
      ...
      <td><input name="name" type="text" id="name" value="<?php echo $row['money'];?>" class="form-control"></td>
    </tr>
	  <?php 
			}
		}

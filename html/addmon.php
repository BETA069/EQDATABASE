...
>
                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h3 class="card-header m-0 me-2 pb-3">เพิ่มแหล่งเงิน</h3>
                        
                      </div>
                     
                      <div class="card-body">
						  <form action="addmon2.php" method="post" >
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center"><input name="name" type="text" id="name" class="form-control"></td>
    </tr>

                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h3 class="card-header m-0 me-2 pb-3">แก้ไขรูปครุภัณฑ์ต่ำกว่าเกณฑ์</h3>
                        
                      </div>
                    <?php  $eid=$_GET['eid'];?>
						<form action="editeqlowpic2.php?eid=<?php echo $eid; ?>" method="post" enctype="multipart/form-data">

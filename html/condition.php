...
<table width="333" border="0" class="table table-hover">
 <tbody>
    <tr style="background-color: #777e5c">
      ...
      <td width="91" align="center"><strong>สภาพครุภัณฑ์</strong></td>
      <td width="85" align="center"><strong>จัดการ</strong></td>
    </tr>
    <tr>
		<?php 
		$sql = "SELECT * FROM `con_equipment`";
		$result = mysqli_query($con, $sql);
		if (mysqli_num_rows($result)>0){
			while ($row = mysqli_fetch_assoc($result)){
				
		?>
      <td align="center"><?php echo $row['con_id'];?></td>
      <td align="center"><?php echo $row['condition'];?></td>
	<td align="center"><a href="editcon.php?eid=<?php echo $row['con_id'];?>">
	  <button type="button" class="btn btn-warning">แก้ไข</button>
	</a>
		<a href="delcon.php?eid=<?php echo $row['con_id'];?>">

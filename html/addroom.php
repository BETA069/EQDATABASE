                ...
                <!-- Total Revenue -->
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-12">
                        <h3 class="card-header m-0 me-2 pb-3">เพิ่มห้องที่ใช้งาน</h3>
                        
                      </div>
                     
                      <div class="card-body">
						  <form action="addroom2.php" method="post" ><table width="333" border="0" class="table table-hover">
  <tbody>
    
    <tr>
      <td align="center"><strong>ห้องที่ใช้งาน</strong></td>
